  ...
  <nav class="navbar navbar-expand-lg navbar-dark p-3 mb-2 bg-primary fixed-top" id="mainNav">
	...
	<div class="login-form">
		<form class="form-inline" action="" method="GET" enctype="multipart/form-data" autocomplete="off">
			...
			<label for="bulan" style="padding-right:20px;">Bulan</label>
	...
	<?php if(isset($_GET['submit'])) : ?>
		<?php
			...
			$bulan = $_GET['bulan'];
			$sql = "SELECT * FROM eRelease WHERE bulan='$bulan'";
		?>
		<h2 class="font-weight-bold text-center">Rekapitulasi E-Release Perbulan</h2>
		<div class="container">
			<?php if ($result = mysqli_query($link, $sql)): ?>
				...
				<?php else : ?>
					<hr class="my-4">
					<h2 class="font-weight-bold text-center">Maaf, Tidak Ada Data Untuk Bulan <?=$bulan ?> </h2>
					<?php endif; ?>
			<?php else: ?>
