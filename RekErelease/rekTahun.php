  ...
  <nav class="navbar navbar-expand-lg navbar-dark p-3 mb-2 bg-primary fixed-top" id="mainNav">
	...
	<div class="login-form">
		<form class="form-inline" action="" method="GET" enctype="multipart/form-data" autocomplete="off">
			<div class="form-group">
				<label for="Tahun" style="padding-right:20px;">Tahun</label>
	...
	<?php if(isset($_GET['submit'])) : ?>
		<?php
			...
			$tahun = $_GET['tahun'];
			$sql = "SELECT * FROM eRelease WHERE tahun='$tahun'";
		?>
		<h2 class="font-weight-bold text-center">Rekapitulasi E-Release Pertahun</h2>
		<div class="container">
			<?php if ($result = mysqli_query($link, $sql)): ?>
				...
				<?php else : ?>
					<hr class="my-4">
					<h2 class="font-weight-bold text-center">Maaf, Tidak Ada Data Untuk Tahun <?=$tahun ?> </h2>
					<?php endif; ?>
			<?php else: ?>
