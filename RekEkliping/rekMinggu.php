...
<html lang="en">
  ...
  <body id="page-top">
		...
		<?php if(isset($_GET['submit1'])) : ?>
			<?php
				$sql = "SELECT * FROM ( SELECT * FROM eklipingCetak ORDER BY tanggal DESC LIMIT 7 ) var1 ORDER BY tanggal ASC";
			?>
			
			<div class="container">
				<?php if ($result = mysqli_query($link, $sql)): ?>
					<?php if(mysqli_num_rows($result) > 0): ?>
						<h2 class="font-weight-bold text-center">Rekapitulasi E-Kliping(Cetak) Perminggu</h2>
						<table class="table">
		...
		<?php elseif(isset($_GET['submit2'])) : ?>
			<?php
				$sql = "SELECT * FROM ( SELECT * FROM eklipingOnline ORDER BY tanggal DESC LIMIT 7 ) var1 ORDER BY tanggal ASC";
			?>
			
			<div class="container">
				<?php if ($result = mysqli_query($link, $sql)): ?>
					<?php if(mysqli_num_rows($result) > 0): ?>
						<h2 class="font-weight-bold text-center">Rekapitulasi E-Kliping(Online) Perminggu</h2>
						<table class="table">
							<thead class="thead-dark">
							<tr>
								<th scope="col">Tanggal</th>
