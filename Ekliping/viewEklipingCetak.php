...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark p-3 mb-2 bg-primary fixed-top" id="mainNav">
		...
		<?php if(isset($_GET['submit'])) : ?>
			<?php
				$search = $_GET['search'];
				$sql = "SELECT * FROM eklipingCetak WHERE media='$search' or judul='$search' or opd='$search'";
			?>
										...
										<div class="carousel-inner">
											<?php if ($row['nama_foto1'] != ""): ?>
												<div class="carousel-item active">
													<img src="../Admin/file e-kliping/cetak/<?php echo $row['nama_foto1']; ?>" class="img-thumbnail" alt="...">
												</div>
											<?php else: ?>
											...
											<?php if ($row['nama_foto2'] != ""): ?>
												<div class="carousel-item">
													<img src="../Admin/file e-kliping/cetak/<?php echo $row['nama_foto2']; ?>" class="img-thumbnail" alt="...">
												</div>
											<?php else: ?>
												<img src="" class="d-block w-100" alt="">
											<?php endif; ?>
											<?php if ($row['nama_foto3'] != ""): ?>
												<div class="carousel-item">
													<img src="../Admin/file e-kliping/cetak/<?php echo $row['nama_foto3']; ?>" class="img-thumbnail" alt="...">
												</div>
											<?php else: ?>
												<img src="" class="d-block w-100" alt="">
											<?php endif; ?>
											<?php if ($row['nama_foto4'] != ""): ?>
												<div class="carousel-item">
													<img src="../Admin/file e-kliping/cetak/<?php echo $row['nama_foto4']; ?>" class="img-thumbnail" alt="...">
												</div>
											<?php else: ?>
												<img src="" class="d-block w-100" alt="">
											<?php endif; ?>
											<?php if ($row['nama_foto5'] != ""): ?>
												<div class="carousel-item">
													<img src="../Admin/file e-kliping/cetak/<?php echo $row['nama_foto5']; ?>" class="d-block w-100" alt="...">
												</div>
											<?php else: ?>
												<img src="" class="d-block w-100" alt="">
											<?php endif; ?>
		...
		<?php else: ?>
			<?php $sql = "SELECT * FROM eklipingCetak"; ?>
			<?php if ($result = mysqli_query($link, $sql)): ?>
				<?php if(mysqli_num_rows($result) > 0): ?>
					<div class="container bg-light">
						<?php while ($row = $result->fetch_assoc()): ?>
