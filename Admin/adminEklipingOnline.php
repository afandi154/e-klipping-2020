...
<html lang="en">
  ...
  <body>
		...
		<div class="login-form">
			<h1 class="font-weight-bold pt-5 text-center">Input Data E-Kliping Online</h1>
		...
		<?php
			if(isset($_POST['submit'])) {
				...
				// Variabel Link Berita
				$linkBerita = $_POST['link'];
			
				// Variabel Foto / Scanning
				$nama_foto1 = $_FILES['foto1']['name'];
				$tmp_foto1 = $_FILES['foto1']['tmp_name']; 
				move_uploaded_file($tmp_foto1, 'file e-kliping/online/'.$nama_foto1);
				
				$nama_foto2 = $_FILES['foto2']['name'];
				$tmp_foto2 = $_FILES['foto2']['tmp_name']; 
				move_uploaded_file($tmp_foto2, 'file e-kliping/online/'.$nama_foto2);
				
				$nama_foto3 = $_FILES['foto3']['name'];
				$tmp_foto3 = $_FILES['foto3']['tmp_name']; 
				move_uploaded_file($tmp_foto3, 'file e-kliping/online/'.$nama_foto3);
				
				$nama_foto4 = $_FILES['foto4']['name'];
				$tmp_foto4 = $_FILES['foto4']['tmp_name']; 
				move_uploaded_file($tmp_foto4, 'file e-kliping/online/'.$nama_foto4);
				
				$nama_foto5 = $_FILES['foto5']['name'];
				$tmp_foto5 = $_FILES['foto5']['tmp_name']; 
				move_uploaded_file($tmp_foto5, 'file e-kliping/online/'.$nama_foto5);
				
				// Variabel OPD
				$opd = $_POST['opd'];
				
				$insert = "INSERT INTO eklipingOnline(tanggal, bulan, tahun, media, judul, link, nama_foto1, nama_foto2, nama_foto3, nama_foto4,  nama_foto5, opd) VALUES ('"
					. $tanggal. "','". $bulan. "','". $tahun. "','". $media. "','". $judul. "','". $linkBerita. "','". $nama_foto1. "','". $nama_foto2. "','". $nama_foto3. "','". $nama_foto4. "','". $nama_foto5. "','". $opd. "');";
